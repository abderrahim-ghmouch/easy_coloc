...
<head>
    ...
    <title>My Flats hares History - EasyColoc</title>
</head>
...
<body class="bg-background-light dark:bg-background-dark font-display text-slate-900 dark:text-slate-100 min-h-screen">
    <div class="flex h-screen overflow-hidden">
        ...
        <div class="flex-1 flex flex-col h-screen overflow-y-auto">
            <header
                class="flex items-center justify-between border-b border-primary/10 px-8 py-4 bg-background-light/80 dark:bg-background-dark/80 backdrop-blur-md sticky top-0 z-40">
                <div class="flex items-center gap-4 flex-1">
                    <label class="flex flex-col min-w-40 h-10 max-w-md flex-1">
                        <div
                            class="flex w-full flex-1 items-stretch rounded-lg h-full bg-slate-200/50 dark:bg-primary/5 border border-transparent focus-within:border-primary/30 transition-all">
                            <div class="text-slate-500 dark:text-primary/60 flex items-center justify-center pl-4">
                                <span class="material-symbols-outlined text-xl">search</span>
                            </div>
                            <input
                                class="form-input flex w-full border-none bg-transparent focus:outline-0 focus:ring-0 h-full placeholder:text-slate-500 dark:placeholder:text-primary/40 px-4 text-sm"
                                placeholder="Search flatshares..." />
                        </div>
                    </label>
                </div>
                <div class="flex items-center gap-6">
                    <div class="flex gap-2">
                        <button
                            class="flex items-center justify-center rounded-lg h-10 w-10 bg-slate-200 dark:bg-primary/10 text-slate-700 dark:text-slate-100 hover:text-primary transition-colors">
            ...
            <main class="flex-1 p-8 flex flex-col gap-8 max-w-7xl mx-auto w-full">
                <div class="flex flex-col gap-1">
                    ...
                    <p class="text-slate-500 dark:text-primary/60">Manage your current and past residential histories
                    </p>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div
                        class="bg-slate-100 dark:bg-primary/5 border border-slate-200 dark:border-primary/10 rounded-2xl p-6 shadow-sm flex flex-col gap-5 opacity-80 hover:opacity-100 transition-all group">
                        <div class="absolute top-0 right-0 p-4">
                            <span
                    ...
                    <div
                        class="border-2 border-dashed border-slate-300 dark:border-primary/20 rounded-2xl p-6 flex flex-col items-center justify-center text-center gap-4 hover:border-primary/50 transition-all group cursor-pointer">
                        <div
                            class="size-14 rounded-full bg-primary/10 flex items-center justify-center text-primary group-hover:scale-110 transition-transform">
                            <span class="material-symbols-outlined text-3xl">add_home</span>
                        </div>
                        <div>
                            <h3 class="text-lg font-bold">New Adventure?</h3>
                            <p class="text-sm text-slate-500 dark:text-primary/40">Join a new flatshare or create your
                                own</p>
                        </div>
