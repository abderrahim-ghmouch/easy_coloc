<aside class="w-64 flex-shrink-0 bg-sidebar-dark border-r border-primary/10 flex flex-col z-50 overflow-y-auto">
            ...
            <nav class="flex-1 px-4 space-y-2 mt-4">
                ...
                <a class="flex items-center gap-3 px-4 py-3 rounded-lg {{ request()->routeIs('admin.dashboard') ? 'bg-accent text-background-dark font-bold shadow-lg shadow-accent/20' : 'text-slate-400 hover:bg-accent/10 hover:text-accent' }} transition-all"
